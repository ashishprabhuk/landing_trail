...
//       <div
//         className="mobile-pills flex md:hidden gap-2 bg-white/10 px-3 py-2 rounded-full border border-white/10 backdrop-blur-lg"
//       >
//         {navItems.map((item) => {
//           const isActive = currentPath === item.path;
//           return (
...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Mobile Pills Fixed at Bottom */}
      <div className="mobile-pills flex md:hidden gap-2 bg-white/10 px-3 py-2 rounded-full border border-white/10 backdrop-blur-lg">
        {navItems.map((item) => {
          const isActive = currentPath === item.path;
          return (
            <button
